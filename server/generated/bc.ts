...
export const ScreenshotRequest: MessageFns<ScreenshotRequest> = {
  encode(message: ScreenshotRequest, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.fps !== 0) {
      writer.uint32(8).int32(message.fps);
    }
    return writer;
  },
  ...
  fromJSON(object: any): ScreenshotRequest {
    return { fps: isSet(object.fps) ? globalThis.Number(object.fps) : 0 };
  },
...
export const BrowserControlService = {
  ...
  setViewport: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: ViewportSize): Buffer => Buffer.from(ViewportSize.encode(value).finish()),
    requestDeserialize: (value: Buffer): ViewportSize => ViewportSize.decode(value),
    responseSerialize: (value: Message): Buffer => Buffer.from(Message.encode(value).finish()),
    responseDeserialize: (value: Buffer): Message => Message.decode(value),
  },
  clickMouse: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Coordinate): Buffer => Buffer.from(Coordinate.encode(value).finish()),
    requestDeserialize: (value: Buffer): Coordinate => Coordinate.decode(value),
    responseSerialize: (value: Message): Buffer => Buffer.from(Message.encode(value).finish()),
    responseDeserialize: (value: Buffer): Message => Message.decode(value),
  },
  sendKeyboardInput: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Text): Buffer => Buffer.from(Text.encode(value).finish()),
    requestDeserialize: (value: Buffer): Text => Text.decode(value),
    responseSerialize: (value: Message): Buffer => Buffer.from(Message.encode(value).finish()),
    responseDeserialize: (value: Buffer): Message => Message.decode(value),
  },
  navigateToUrl: {
    ...
    requestStream: false,
    responseStream: false,
    requestSerialize: (value: Url): Buffer => Buffer.from(Url.encode(value).finish()),
    requestDeserialize: (value: Buffer): Url => Url.decode(value),
    responseSerialize: (value: Message): Buffer => Buffer.from(Message.encode(value).finish()),
    responseDeserialize: (value: Buffer): Message => Message.decode(value),
  },
  /** Streaming RPC for continuous screenshots */
  streamScreenshots: {
    path: "/pb.BrowserControl/StreamScreenshots",
    requestStream: false,
    responseStream: true,
...
export interface BrowserControlServer extends UntypedServiceImplementation {
  ...
  /** Streaming RPC for continuous screenshots */
  streamScreenshots: handleServerStreamingCall<ScreenshotRequest, Screenshot>;
}
...
export interface BrowserControlClient extends Client {
  ...
  /** Streaming RPC for continuous screenshots */
  streamScreenshots(request: ScreenshotRequest, options?: Partial<CallOptions>): ClientReadableStream<Screenshot>;
  streamScreenshots(
    request: ScreenshotRequest,
    metadata?: Metadata,
    options?: Partial<CallOptions>,
  ): ClientReadableStream<Screenshot>;
}
